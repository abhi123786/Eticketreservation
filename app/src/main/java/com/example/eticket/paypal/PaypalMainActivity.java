...
public class PaypalMainActivity extends AppCompatActivity {
    ...
    TextView check_balance, wallet_balance;
    String walletAmount = "";
    //Payment Amount
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonPay = (Button) findViewById(R.id.add_balance);
        editTextAmount = (EditText) findViewById(R.id.editTextAmount);
        check_balance = (TextView) findViewById(R.id.check_balance);
        wallet_balance = (TextView) findViewById(R.id.wallet_balance);
        databaseHelper = new DatabaseHelper(PaypalMainActivity.this);


        check_balance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                SharedPreferences getpreferences = PreferenceManager.getDefaultSharedPreferences(PaypalMainActivity.this);
                walletAmount = getpreferences.getString("walletamount", "");
                String userId = getpreferences.getString("userId", "");


                wallet_balance.setText("Your Wallet Balance : " + databaseHelper.getWalletAmount(userId));
